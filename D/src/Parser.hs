...
happyExpList = Happy_Data_Array.listArray (0,52) ([12288,2,35,560,18432,0,16384,16,8,0,12288,2,35,0,0,0,0,4,0,8960,12288,2,35,560,8960,0,0,0,0,128,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseProblem","%start_parseExpression","Problem","Context","Expression","Disjunction","Conjunction","Negation","or","and","not","open","close","comma","impl","var","turn","%eof"]
        bit_start = st * 20
        bit_end = (st + 1) * 20
...
action_5 (11) = happyShift action_16
...
action_15 (10) = happyGoto action_24
